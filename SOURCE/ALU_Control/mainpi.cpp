...
public:
	...
	ALU() : A(0), B(0), Instruction(0), Result(0), CarryOut(0), ClockPeriod{ 200000 }
	{
	}
...
int main(int argc, char* argv[])
{
	...
	if(clockfrequency > 0) RelayALU.ClockPeriod = 1000000 / clockfrequency;
	...
	while ((!finished) && (PC < MEMORY.size()))
	{
		...
		if (clockfrequency == 0) pausescreen();	
